...
echo -e "\n\n"
echo -e "${GREEN}correct answer...${NONE} \n\n"	
fi
}	
...
clear
echo -e "\n\n\n\n"
#qsnread=`cat $HOME/K8s-Lab-Questions/CKA_Lab1/questions/"$i"`
...
#for i in `ls $HOME/K8s-Lab-Questions/CKA_Lab1/questions`
for i in "${!questionlst[@]}"
do
#qsn_no=`echo "${i}" | cut -d'.' -f1`	
qsn_no=`expr ${i} + 1`	
clear
echo -e "\n\n\n\n"
#qsnread=`cat $HOME/K8s-Lab-Questions/CKA_Lab1/questions/"$i"`
